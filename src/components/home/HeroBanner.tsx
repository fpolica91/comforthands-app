        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 py-10 lg:py-16">
          ...
          <div className="w-full lg:hidden">
            <video
              ...
              loop
              playsInline
              poster="/images/products/IMG-20251006-WA0027.jpg"
            >
              <source src="/videos/VideoBanner-compressed.mp4" type="video/mp4" />
          ...
          <div className="w-full lg:w-[60%] flex flex-col gap-6">
            <h1 className="text-4xl lg:text-6xl font-bold !text-white leading-tight">
              Embrace Comfort,{" "}
              <span className="block">Release Tension</span>
            </h1>
